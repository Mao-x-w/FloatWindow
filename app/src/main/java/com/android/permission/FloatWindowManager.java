...
//        imageView.setImageResource(R.drawable.app_icon);
        ...
        floatView.setOnClickListener(new AVCallFloatView.OnClickLisener() {
            @Override
            public void onclick() {
                windowManager.removeView(floatView);
                showMoveView(context);
    ...
    private void showMoveView(Context context) {
        final AVCallFloatView2 avCallFloatView2=new AVCallFloatView2(context);
        avCallFloatView2.setOnSimulateClickListener(new AVCallFloatView2.OnSimulateClickListener() {
            @Override
            public void onSimulateClick() {
                windowManager.removeView(avCallFloatView2);
                windowManager.addView(floatView, mParams);
            }
        });
        ...
        windowManager.addView(avCallFloatView2,params);
    }
